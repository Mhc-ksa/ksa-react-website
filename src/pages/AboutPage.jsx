...
function AboutPage() {
    return (
        <div className='width-70 text-center-about'>
            <div>
                <h1 className='padding-top-120 about-ksa-font'>KSA</h1>
                <h3 className='about-title-font'>Korean Student Association</h3>
                <h6 className='about-content-font'>Mount Holyoke College</h6>
                <img className='img-center-about' src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_South_Korea.svg/800px-Flag_of_South_Korea.svg.png" alt="South Korea flag" />
            </div>

            <div className="about-part">
                <h2 className='margin-16-about about-title-font'>Purpose</h2>
                <p className='text-align-about about-content-font'>The purpose of KSA is to support those who identify as Korean and Korean-American and increase awareness of Korean culture both on and off campus. Additionally, we aim to help minorities establish their identities in America through spreading knowledge and cultural events.</p>
            </div>

            <div className="about-part">
                <h2 className='margin-16-about about-title-font'>History</h2>
                <p className='text-align-about about-content-font'>KSA is one of many cultural organizations in Mount Holyoke College. Though the origins of KSA is unclear, the earliest known record of KSA’s presence (as of April 2018) is 1999.
            ...
            <div className='about-part'>
                <h2 className='margin-16-about about-title-font'>Executive board</h2>
                <div className='flex-about justify-center-about'>
                    {MemberInfo.map( (member, index) => 
                        <MemberCard key={index} photo={member.photo} name={member.name} role={member.role} />
                    )}
                </div>
            </div>

            <div className='about-part'>
                <h2 className='margin-16-about about-title-font'>Logo</h2>
                <img className='logo-image-about' src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Flag_of_South_Korea.svg/800px-Flag_of_South_Korea.svg.png" alt="ksa logo" />
